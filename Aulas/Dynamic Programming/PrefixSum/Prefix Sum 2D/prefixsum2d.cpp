...
using namespace std;
const int N = 1e3+5;
int m[N][N],ps[N+1][N+1];
// Obs: Estamos considerando q o primeiro elemento da matriz eh dado em x = 1 , y = 1 (a11) e nao em x=0,y=0
// Se a entrada der x=0 e y=0 como primeiro elemento da matriz, so dar x++ y++ para indexar com o nosso codigo
int main(){
    cin.tie(NULL);
